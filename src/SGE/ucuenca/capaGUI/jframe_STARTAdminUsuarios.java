 ...
 * @author JHON
 */
public class jframe_STARTAdminUsuarios extends javax.swing.JFrame {

    private static String getPasword;
    
    public jframe_STARTAdminUsuarios() {
        initComponents();
    ...
    private void jButton_conectarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_conectarActionPerformed
        ...
        objConn.cn = objConn.con.Conectar(jTextField_usuario.getText(), getPasword);    //Ingresar con los datos de INICIO SESION;
//        objConn.Conectar(jTextField_usuario.getText(), getPasword);
        ...
        try {
            ...
            Logger.getLogger(jframe_STARTAdminUsuarios.class.getName()).log(Level.SEVERE, null, ex);
        }

        jframe_adminUsuarios vPrincipal = new jframe_adminUsuarios();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jframe_STARTAdminUsuarios.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new jframe_STARTAdminUsuarios().setVisible(true);
            }
        });
    }
